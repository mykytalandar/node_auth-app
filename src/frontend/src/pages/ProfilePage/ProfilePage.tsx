    ...
    <div className="profile background-white">
      <div className="profile-separator">
        ...
        <div className="profile-main">
          {user && activeSection === 'information' && <ProfileInfo user={user}/>}
          {user && activeSection === 'changePassword' && <ProfileChangePassword user={user}/>}
          {user && activeSection === 'changeEmail' && <ProfileChangeEmail user={user}/>}
        </div>
      </div>
    </div>
  );
